...
/**
 * Tests the sort method in the ModifiedOrdering class, this class sorts a list of
 * MarkdownFiles by last modified
 */
class ModifiedOrderingTest {
  /**
   * Tests the sort method in the ModifiedOrdering, assigns sample files a modified date
   * and ensures they are correctly tested
   */
  @Test
  public void testSort() {
    ...
    ModifiedOrdering ordering = new ModifiedOrdering();
